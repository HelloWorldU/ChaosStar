...
CLIENT_CHOICE_VALUES = tuple(choice.value for choice in ClientChoice)
CLIENT_CHOICE_TYPE = Literal[CLIENT_CHOICE_VALUES]
...
class Message(BaseModel):
    ...
    role: Role = Field(...)
    content: Optional[Union[str, List[Union[ContentBlock, dict]]]] = Field(default=None)
    ...
    @classmethod
    def user_message(
        cls, content: Union[str, List[dict]], base64_image: Optional[str] = None
    ) -> "Message":
    ...
    def assistant_message(
        cls, content: Optional[Union[str, List[ContentBlock]]] = None, base64_image: Optional[str] = None
    ) -> "Message":
...
class Memory(BaseModel):
    """Stores and manages an agent’s conversational history."""
...
class Resource(BaseModel):
    """Represents a resource with a name and content"""
